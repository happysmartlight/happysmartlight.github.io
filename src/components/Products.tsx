  ...
  const products: Product[] = [
    {
      ...
      features: [
        ...
        "Anten rời truyền nhận sóng cực xa và ổn định",
        "Hỗ trợ pin LiPo/Lithium và sạc trực tiếp ngay trên mạch, tiện cho thiết bị di động",
      ...
      specs: [
        ...
        { label: "Cấu trúc bo mạch", value: "PCB 4 lớp chất liệu cao cấp, thiết kế nhỏ gọn" },
        { label: "Kết nối không dây", value: "Anten rời truyền nhận sóng cực xa và ổn định" },
        { label: "Nguồn cấp", value: "DC 5V, hỗ trợ pin LiPo/Lithium 3.7-4.2V & sạc trực tiếp" },
    ...
    },
    {
      ...
      price: "930.000 VND",
      description: "Bộ điều khiển ARGB công suất lớn cực kỳ mạnh mẽ, chịu dòng cực cao, tối ưu 4.000-5.000 LED pixel. Chuyên dụng cho matrix pixel, trống led matrix, cờ led matrix sự kiện. Mạch chạy 5V điều khiển LED đa dải 5/12/24/48V, bản nâng cấp X2 bộ nhớ, hỗ trợ module ETH & thẻ nhớ SD.",
      features: [
        "Điều khiển tối ưu 4.000 - 5.000 LED pixel, chịu dòng tải cực cao cho sự kiện lớn",
        "4 cổng ra LED ARGB độc lập tích hợp diode chống dòng dội ngược bảo vệ mạch",
        "Mạch chạy mức 5V, điều khiển LED đa dải điện áp DC 5V / 12V / 24V / 48V",
        "Chống chập nguồn khi đấu nhầm cực, IC chuyển mức Level Shifter tín hiệu ổn định sắc nét",
        "Bản mới: X2 bộ nhớ, khe module ETH & thẻ nhớ SD, vị trí hàn nút bấm riêng, firmware báo nhiệt độ mạch",
      ],
      specs: [
        { label: "Vi xử lý", value: "ESP32 ARM Dual-Core 240MHz" },
        { label: "Số lượng LED", value: "Tối ưu vận hành 4.000 - 5.000 LED pixel" },
        { label: "Điện áp", value: "Mạch 5V, điều khiển LED đa dải DC 5V / 12V / 24V / 48V" },
        { label: "Cấp nguồn tối đa", value: "Cầu đấu đồng khối mạ niken gánh tải liên tục lên tới 30A" },
        { label: "Bộ nhớ & mở rộng", value: "X2 bộ nhớ lưu visual, khe module ETH & thẻ nhớ SD" },
        { label: "Bảo vệ mạch", value: "Chống đấu nhầm cực, chống ngược cực nguồn và xả tải an toàn" },
      ],
