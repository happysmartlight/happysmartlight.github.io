...
export default function Products({ onQuoteRequested, onViewProductDetails }: ProductsProps) {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      price: "930.000 VND",
      description: "Bộ điều khiển ARGB công suất lớn cực kỳ mạnh mẽ, chịu dòng cực cao. Chuyên dụng cho các ứng dụng làm matrix pixel, trống led matrix, cờ led matrix sự kiện. Bản nâng cấp X2 bộ nhớ, hỗ trợ module ETH & thẻ nhớ SD.",
      features: [
        ...
        "Bản mới: X2 bộ nhớ lưu visual dài hơn, có khe module ETH & thẻ nhớ SD, vị trí hàn nút bấm riêng",
      ],
      specs: [
        { label: "Vi xử lý", value: "ESP32 ARM Dual-Core 240MHz" },
